...
/***/ function(module, exports, __webpack_require__) {
	...
	var Listing = __webpack_require__(230);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(Route, { path: '/products', component: Listing })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = function Home() {
	  return React.createElement(
	    ...
	    React.createElement(
	      Link,
	      { className: 'products-link', to: '/products' },
	      'View Products'
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Product = __webpack_require__(231);
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.state.products.filter(function (product) {
	          return (product.name + ' ' + product.description).toUpperCase().indexOf(_this2.state.searchQuery.toUpperCase()) >= 0;
	        }).map(function (product) {
	          return React.createElement(Product, _extends({}, product, { key: product.itemID }));
	        })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Product = function Product(props) {
	  return React.createElement(
	    'div',
	    { className: 'product' },
	    React.createElement('img', { src: 'images/' + props.image, className: 'product-image' }),
	    React.createElement(
	      'div',
